...
function Posts() {
  ...
  const likePost = (postIndex) => updateLikes(postIndex, 1);
  const dislikePost = (postIndex) => updateLikes(postIndex, -1);
        ...
        {postList.map((post, index) => (
          <div key={post.id} className="post-item">
            ...
            <div className="post-actions">
              <button className="like-button" onClick={() => likePost(index)}>
                Like
              </button>
              <button
